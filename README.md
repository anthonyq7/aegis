...
### Baseline Comparison
A baseline was achieved by testing CodeBERT using the same test dataset. For the sequence classification task of flagging AI-generated code, CodeBERT achieved an accuracy of 60.25%, a precision of 62.42%, and a recall score of 51.50%. These metrics can be confirmed by running the baseline.py script. 
